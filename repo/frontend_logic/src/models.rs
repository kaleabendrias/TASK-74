//! Data transfer objects — mirrors frontend/src/models/mod.rs exactly.
//! Adding Serialize+Deserialize+PartialEq to every type so that both the
//! frontend (Serialize/Deserialize) and unit tests (PartialEq + round-trips)
